...
# Create the directory to store extracted .fna files
mkdir -p ../genomic_fna
# Loop over all genome ZIP files in the directory
for zip_file in *_genome.zip; do
    # Extract the species and assembly name from the file name
